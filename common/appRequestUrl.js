const baseUrl = "http://192.168.1.6:9091/MySchool";
...
const getUserList = baseUrl +"/user/getUserList";

const getScoreByUid = baseUrl + "/scSubject/getScoreByUid";

const addScore = baseUrl + "/scSubject/addScore";
